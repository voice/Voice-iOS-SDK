#
#  Be sure to run `pod spec lint Voice-iOS-SDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Alexandre barbier"
  # s.authors            = { "Alexandre barbier" => "alexandr.barbier@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Alexandre barbier"
